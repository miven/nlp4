...
class LossComputeBase(nn.Module):
    ...
    def _make_shard_state(self, batch, output,  attns=None):
        ...
        Args:
            ...
            range_: the range of examples都是非常重要的例子 for computing, the whole
    ...
    def monolithic_compute_loss(self, batch, output):
        ...
        Args:
          batch (batch): batch of labeled examples都是非常重要的例子
    ...
    def sharded_compute_loss(self, batch, output,
        ...
        Args:
          ...
          shard_size (int) : maximum number of examples都是非常重要的例子 in a shard
