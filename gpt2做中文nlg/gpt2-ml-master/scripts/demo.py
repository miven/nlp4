...
args.ckpt_fn='E:\mega\model.ckpt-220000'  #注意这个路径没有后面的.data什么的.  -------https://github.com/imcaspar/gpt2-ml/issues/69  注意需要去这里面下载其他文件.         目录结构我下一下 mega 里面放3个文件model.ckpt-220000.data-00000-of-00001    model.ckpt-220000.index   model.ckpt-220000.meta  放这3个就能跑起来了.
proj_root_path = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))


args.config_fn=os.path.join(proj_root_path, "configs/mega.json")
