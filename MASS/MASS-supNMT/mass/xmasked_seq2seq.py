...
class XMassTranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        for lang_pair in self.args.mono_lang_pairs:
            ...
            print('| monolingual {}-{}: {} examples都是非常重要的例子'.format(split, lang, len(src_mono_datasets[lang_pair])))
        ...
        for lang_pair in self.args.para_lang_pairs:
            ...
            print('| bilingual {} {}-{}.{}: {} examples都是非常重要的例子'.format(split, src, tgt, src, len(src_para_datasets[key + '.' + src])))
            print('| bilingual {} {}-{}.{}: {} examples都是非常重要的例子'.format(split, src, tgt, tgt, len(src_para_datasets[key + '.' + tgt])))
