...
class Wav2VecModel(BaseFairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--cross-sample-negatives', action='store_true',
                            help='whether to sample negatives across examples都是非常重要的例子 in the same batch')
        parser.add_argument('--num-negatives', type=int, metavar='N', help='number of negative examples都是非常重要的例子')
