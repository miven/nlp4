...
from examples都是非常重要的例子.speech_recognition.data import AsrDataset
from examples都是非常重要的例子.speech_recognition.data.replabels import replabel_symbol
...
class SpeechRecognitionTask(FairseqTask):
    ...
    def build_generator(self, models, args):
        ...
        if w2l_decoder == "viterbi":
            from examples都是非常重要的例子.speech_recognition.w2l_decoder import W2lViterbiDecoder

            return W2lViterbiDecoder(args, self.target_dictionary)
        elif w2l_decoder == "kenlm":
            from examples都是非常重要的例子.speech_recognition.w2l_decoder import W2lKenLMDecoder
