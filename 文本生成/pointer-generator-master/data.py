...
def example_generator(data_path, single_pass):
  ...
  Args:
    ...
    single_pass:
      Boolean. If True, go through the dataset exactly once, generating examples都是非常重要的例子 in the order they appear, then return. Otherwise, generate random examples都是非常重要的例子 indefinitely.
