...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    """Decode examples都是非常重要的例子 until data is exhausted (if FLAGS.single_pass) and return, or decode indefinitely, loading latest checkpoint at regular intervals"""
    t0 = time.time()
    counter = 0
    while True:
      ...
      if FLAGS.single_pass:
        ...
        counter += 1 # this is how many examples都是非常重要的例子 we've decoded
      else:
