...
def main():
    ...
    '''
    -raw_dir tmp/raw_deen -data_dir bpe_deen -save_data bpe_vocab.pkl -codes codes.txt -prefix deen
    
    
    
    
    bpe: pingxingyuliao ---------src vocab    tgt vocab
    ...
    parser.add_argument('-codes', required=False)
    ...
    opt.raw_dir='tmp/raw_deen'
    opt.data_dir='bpe_deen'
    opt.codes='bpe_vocab.pkl'
    opt.save_data='codes.txt'
    opt.prefix='deen'
