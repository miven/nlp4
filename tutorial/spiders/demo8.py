...
# 下面是直接匹配方式获取所有index页.
    ...
    saveall=[
        ...
        #'http://www.171english.cn/news/2018/june/',
             'https://ru.hujiang.com/new/yuedu/',
    ...
    def parse(self, response): # 一级爬取代码
        ...
        div_list = response.xpath('//li[@class="list-item"]/a/@href')  # 加入正则


        div_list=['https://ru.hujiang.com'+i.extract() for i in div_list]
