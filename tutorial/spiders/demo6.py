...
# 下面是直接匹配方式获取所有index页.
    ...
    def parse(self, response): # 一级爬取代码
        ...
        div_list = response.xpath('//div[@class="newslist solid"]/ul/divnewslist/li/a/@href')  # 加入正则
        div_list=['http://www.for68.com/'+i.extract() for i in div_list]
