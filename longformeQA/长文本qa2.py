...
print(answer)
'''
可以考虑后续更改这个注意力算法, 因为qa目前是对question进行全注意力计算, 其实可以 把所有名词和动词都进行全注意力计算.因为他们往往是qa
需要输出的答案.他们多计算是有好处的.
'''
